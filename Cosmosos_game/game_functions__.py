...
def check_bullet_alien_collisions(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    if len(aliens) == 0:
        ...
        #Если флот уничтожен, запускаем следующий уровень
        bullets.empty()
...
def check_play_button(ai_settings, screen, stats, sb, play_button,
    ...
    """Запускает новую игру при нажатии ктопки Play"""
    ...
    if button_clicked and not stats.game_active:
        ...
        #Сброс изображений счётов и уровней
        sb.prep_score()
        sb.prep_high_score()
        sb.prep_level()
        sb.prep_ships()
...
def get_number_aliens_x(ai_settings, alien_width):
    ...
    available_space_x = ai_settings.screen_weight - 2 * alien_width
...
def create_fleet(ai_settings,screen,ship, aliens):
    ...
    # Создание пришельца и вычисление количества пришельцев в рядy
    alien = Alien(ai_settings, screen,)
...
def update_aliens(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    #Проверка коллизий с пришельца и корабля
